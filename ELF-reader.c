...
static const char *option_chars = "hS ";
static const char *option_strs[] = {"--file-header", "--section-headers", "--dec", NULL};
static const proc option_procs[] = {display_file_header, display_section_headers, dummy_proc, NULL};
